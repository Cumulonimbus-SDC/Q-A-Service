...
let readStream = fs.createReadStream("../../CSVs/answers.csv");
let writeStream = fs.createWriteStream("../../CSVs/cleanAnswers.csv");
...
class CSVCleaner extends Transform {
  ...
  _transform(chunk, encoding, next) {
    ...
    let onlyNumbersB = chunk.question_id.replace(/\D/g, "");
    chunk.question_id = onlyNumbersB;
